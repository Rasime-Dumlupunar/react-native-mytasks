...
import { ArrowCircleRight2, ChartCircle, Clock, CloseCircle, TickCircle } from 'iconsax-react-native';
...
const HeaderComponent = ({ongoing, pending, complated, cancel}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Text style={{ marginLeft: 17, marginTop:10, fontSize:18, fontWeight: "600" }}>All Tasks </Text>
      </View>
    </View>
  )
} 
